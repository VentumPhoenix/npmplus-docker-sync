...
func (f *fakeAPI) List(_ context.Context, kind npm.Kind) ([]npm.Resource, error) {
...
func (f *fakeAPI) Create(_ context.Context, resource npm.Resource) (npm.Resource, error) {
...
func (f *fakeAPI) Update(_ context.Context, id int, resource npm.Resource) (npm.Resource, error) {
...
func (f *fakeAPI) Delete(_ context.Context, kind npm.Kind, id int) error {
