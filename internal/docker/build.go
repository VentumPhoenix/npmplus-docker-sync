...
func buildLocation(t *Target, f fieldSet, n int, values map[string]string) (npm.Location, error) {
	...
	return npm.Location{
		...
		Enabled:                  &enabled,
		NoIndex:                  noIndex,
		DisableCrowdsecAppsec:    !crowdsec,
		DisableRequestBuffering:  !requestBuffering,
		DisableResponseBuffering: !responseBuffering,
		UpstreamCompression:      upstreamCompression,
